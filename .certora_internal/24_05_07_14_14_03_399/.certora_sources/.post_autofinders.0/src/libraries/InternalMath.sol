...
library InternalMath {
    ...
    function getNextPriceSqrtX96OnAmount1RoundingUp(uint160 _sqrtPriceX96, uint256 _liquidity, uint256 _amount)
        ...
        pure
        returns (uint160 nextPriceSqrtX96)
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030000, 1037618708483) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00036002, _amount) }
    ...
    /// @param sqrtPriceAX96 is the price A in Q69.96
    /// @param sqrtPriceBX96 is the price B in Q69.96
    /// @param liquidity is the current pool liquidity.
    /// @param roundUp is the direction of the swap.
    /// @return amount0 is the amount of delta(x) in here.
    function calculateDeltaToken0(
        uint160 sqrtPriceAX96,
        uint160 sqrtPriceBX96,
        uint128 liquidity,
        bool roundUp
    ) internal pure returns (uint256 amount0) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040000, 1037618708484) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00046003, roundUp) }
        ...
        if (roundUp) {
            // represent => (L * (sqrtp0 - sqrtp1)) / (sqrtp0 * sqrtp1)
            ...
            amount0 =
                mulDivision(numerator1, numerator2, sqrtPriceBX96) /
                sqrtPriceAX96;
        }
    }
    ...
    function calculateDeltaToken1(
        ...
        uint128 liquidity,
        bool roundUp
    ) internal pure returns (uint256 amount1) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00020000, 1037618708482) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00020001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00020005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00026003, roundUp) }
        if (sqrtPriceAX96 > sqrtPriceBX96)
            (sqrtPriceAX96, sqrtPriceBX96) = (sqrtPriceBX96, sqrtPriceAX96);
    ...
    function calculateDeltaToken0(
        ...
        uint160 sqrtPriceBX96,
        int128 liquidity
    ) internal pure returns (int256 amount0) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050000, 1037618708485) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00056002, liquidity) }
        amount0 = liquidity < 0
            ? -int256(
    ...
    // @audit-info writing firmal verification for this function
    function mulDivRoundingUp(uint256 a, uint256 b, uint256 denominator) internal pure returns (uint256 result) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070000, 1037618708487) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00076002, denominator) }
        result = mulDivision(a, b, denominator);
    ...
    function divRoundingUp(uint256 numerator, uint256 denominator) internal pure returns (uint256 result) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080000, 1037618708488) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00086001, denominator) }
        assembly {
            result := add(div(numerator, denominator), gt(mod(numerator, denominator), 0))
        }
    }

    function tryAdd(uint256 a, uint256 b) internal pure returns (uint256 result) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00090000, 1037618708489) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00090001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00090005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00096001, b) }
        unchecked {
            uint256 c = a + b;
