...
contract tickBitmapTest is Test {
    ...
    function testNextInitializedTickViaWordWhenDirectionIsTrue() public {
        ...
        (int24 nextTick1, bool initialized1) = Bitmap.nextInitializedTickViaWord(78, defualt_space, direction);
        assertEq(nextTick1, 78);
        assertTrue(initialized1);

        (int24 nextTick2, bool initialized2) = Bitmap.nextInitializedTickViaWord(79, defualt_space, direction);
        assertEq(nextTick2, 78);
        assertTrue(initialized2);

        (int24 nextTick3, bool initialized3) = Bitmap.nextInitializedTickViaWord(258, defualt_space, direction);
        assertEq(nextTick3, 256);
        assertFalse(initialized3);

        (int24 nextTick4, bool initialized4) = Bitmap.nextInitializedTickViaWord(256, defualt_space, direction);
        assertEq(nextTick4, 256);
        assertFalse(initialized4);

        (int24 nextTick5, bool initialized5) = Bitmap.nextInitializedTickViaWord(72, defualt_space, direction);
    ...
    function testNextInitializedTickViaWordWhenDirectionIsFalse() public {
        ...
        (int24 nextTick2, bool initialized2) = Bitmap.nextInitializedTickViaWord(-55, defualt_space, direction);
        assertEq(nextTick2, -4);
        assertTrue(initialized2);

        (int24 nextTick3, bool initialized3) = Bitmap.nextInitializedTickViaWord(77, defualt_space, direction);
        assertEq(nextTick3, 78);
        assertTrue(initialized3);

        (int24 nextTick4, bool initialized4) = Bitmap.nextInitializedTickViaWord(-56, defualt_space, direction);
        assertEq(nextTick4, -55);
        assertTrue(initialized4);

        (int24 nextTick5, bool initialized5) = Bitmap.nextInitializedTickViaWord(255, defualt_space, direction);
